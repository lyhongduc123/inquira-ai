...
export function ProgressEventSheet({
  ...
  const pipelineType =
    displayThoughts.length > 0
      ? (displayThoughts[0].pipeline_type ??
        displayThoughts[0].pipelineType ??
        null)
      : null;
  ...
  return (
    <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
      ...
      >
        <>
          ...
          <HStack className="items-center gap-1 min-w-0">
            <OpacityShimmer
              className="text-xs"
              isActive={!queryProgress.isComplete}
            >
              {hasNoEventsYet
                ? `${suffleText}...`
      ...
      >
        ...
        <ScrollArea className="flex-1 min-h-0 pt-2 px-4">
          <StepAccordion
            value={
              latestStep
  ...
  return (
    ...
    >
      {displayThoughts.map((thought, idx) => {
        ...
        return (
          <div key={stepKey} className="relative flex gap-2 pb-4">
            ...
            >
              <AccordionTrigger
                className={cn(
                  "group w-full justify-between rounded-xl px-2 py-2 transition-colors ",
              ...
              >
                <HStack className="gap-3 items-center min-w-0">
                  ...
                  >
                    {changeCase.capitalCase(thought.type)}
                  </TypographyP>
                </HStack>
              </AccordionTrigger>
